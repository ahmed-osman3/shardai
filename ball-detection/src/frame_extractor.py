...
- motion: N frames with highest inter-frame motion (best for ball labelling).
...
# Downsample resolution used for motion scoring — grayscale 320×180
...
class FrameExtractor:
    ...
    def extract(
        ...
        Args:
            ...
            output_dir: Directory to write frame images. Created if absent.
            strategy: Sampling strategy.
            count: Number of frames to extract (ignored by "manual").
            every_n: Save every Nth frame (used only by "manual").
        ...
        logger.info("Extracting frames from %s (%d total, strategy=%s)", video_path.name, total, strategy)
